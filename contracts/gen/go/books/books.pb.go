...
func (x *FindByAuthorRequest) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *FindByAuthorRequest) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *FindByAuthorRequest) GetBooks() []*Book {
	if x != nil {
		return x.Books
	}
	return nil
...
var file_proto_books_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x62, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20,
	...
	0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x27, 0x0a, 0x11, 0x46, 0x69, 0x6e, 0x64, 0x42, 0x79,
	...
	0x6f, 0x6b, 0x22, 0x74, 0x0a, 0x13, 0x46, 0x69, 0x6e, 0x64, 0x42, 0x79, 0x41, 0x75, 0x74, 0x68,
	0x6f, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x72, 0x72,
	...
	0x6b, 0x52, 0x05, 0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x32, 0x6f, 0x0a, 0x0c, 0x42, 0x6f, 0x6f, 0x6b,
	0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x5f, 0x0a, 0x0a, 0x46, 0x69, 0x6e, 0x64,
...
var file_proto_books_proto_depIdxs = []int32{
	...
	0, // 1: books_service.books.FindByAuthorRequest.books:type_name -> books_service.books.Book
	1, // 2: books_service.books.BooksService.FindByISBN:input_type -> books_service.books.FindByISBNRequest
	2, // 3: books_service.books.BooksService.FindByISBN:output_type -> books_service.books.FindByISBNResponse
